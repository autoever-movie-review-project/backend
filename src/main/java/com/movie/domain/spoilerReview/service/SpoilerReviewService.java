...
public class SpoilerReviewService {
    ...
    public Long save(Long reviewId) {
        ...
        if (spoilerReviewRepository.existsByUserUserIdAndReviewReviewId(loggedInUser.getUserId(), reviewId)) {
        ...
        Long countLikes = spoilerReviewRepository.countByReviewReviewId(reviewId);
